...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../Vista/css/cssGGastos.css">
        
        <title>Factur - Gestionar Gastos</title>
    </head>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="md-form">
                                                ...
                                                <label for="form1" class="">Marca</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="md-form">
                                                ...
                                                <label for="form2" class="">Total</label>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="md-form">
                                                ...
                                                <label for="textareaPrefix">Descripción</label>
                                                <small id="Help3" class="form-text text-muted">
                                                Ingrese una Descripcion (Opcional).
                                                </small>
                                            </div>
