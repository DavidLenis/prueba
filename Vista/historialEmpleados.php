...
<html lang="es">
    <head>
        ...
        <title>Factur - Historial Empleados</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="md-form">
                                                <i class="fa fa-list prefix" aria-hidden="true"></i>
                                                <input type="text" id="form4" class="form-control" required autofocus>
                                                <label for="form4">Buscar Registro</label>
                                                <small id="Help3" class="form-text text-muted">
                                                    Ingrese la Fecha para Filtrar  (Mes/Dia/Año).
                                                </small>
                                            </div>
                                            ...
                                            <table class="table" id="">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Victor</td>
                                                        <td>Mesero</td>
                                                        <td>10/08/2018 - 6:00 am</td>
                                                        <td>10/08/2018 - 5:00 pm</td>
                                                    </tr>
